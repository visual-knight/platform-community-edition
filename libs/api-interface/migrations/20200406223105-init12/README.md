# Migration `20200406223105-init12`

This migration has been generated by Filtering is added at 4/6/2020, 10:31:05 PM.
...
CREATE UNIQUE INDEX "TestSession_baselineRefId" ON "public"."TestSession"("baselineRefId")
...
ALTER TABLE "public"."TestSession" ADD FOREIGN KEY ("baselineRefId")REFERENCES "public"."Variation"("id") ON DELETE SET NULL  ON UPDATE CASCADE
```
...
migration 20200406220516-init1..20200406223105-init12
--- datamodel.dml
+++ datamodel.dml
@@ -2,9 +2,9 @@
 datasource db {
