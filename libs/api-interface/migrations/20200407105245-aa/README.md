# Migration `20200407105245-aa`

This migration has been generated by Filtering is added at 4/7/2020, 10:52:45 AM.
...
CREATE UNIQUE INDEX "Variation_baseline" ON "public"."Variation"("baseline")
...
ALTER TABLE "public"."Variation" ADD FOREIGN KEY ("baseline")REFERENCES "public"."TestSession"("id") ON DELETE SET NULL  ON UPDATE CASCADE
...
+  binaryTarget = ["native", "linux-glibc-libssl1.0.2", "darwin", "windows"]
